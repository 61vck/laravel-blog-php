...
<head>
    ...
    <link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.10.0/css/all.css" integrity="sha384-AYmEC3Yw5cVb3ZcuHtOA93w35dYTsvhLPVnYs9eStHfGJvOvKxVfELGroGkvsg+p" crossorigin="anonymous"/>    <title>@yield('title')</title>
</head>
<body>
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <a class="navbar-brand" href="{{route('posts.index')}}">RON</a>
                ...
                @if (Route::has('login'))
                    @auth
                            <form class="d-inline" method="POST" action="{{ route('logout') }}">
                                ...
                                <button class="btn btn-success dis justify-items-end">Logout</button>
                            </form>
        ...
        <div>
        <form method="GET" action="{{url('/search.results')}}"  class="d-flex px-2">
